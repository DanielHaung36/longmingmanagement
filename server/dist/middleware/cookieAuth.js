...
exports.requireApprover = exports.requireManager = exports.requireAdmin = void 0;
exports.cookieAuth = cookieAuth;
exports.optionalCookieAuth = optionalCookieAuth;
 ...
 */
async function optionalCookieAuth(req, res, next) {
    try {
        const sessionToken = cookieAuthService_1.CookieAuthService.extractToken(req.cookies);
        if (sessionToken) {
            const user = await cookieAuthService_1.CookieAuthService.verifySession(sessionToken, res);
...
exports.requireAdmin = requireRole('ADMIN', 'MANAGER');
// 管理员或项目经理权限
exports.requireManager = requireRole('ADMIN', 'MANAGER');
// 审批权限（用于Task审批）
exports.requireApprover = requireRole('ADMIN', 'MANAGER');
/**
 * 资源所有权验证中间件工厂函数
 *
