 ...
 *                     type: string
 */
router.get("/client-companies", projectController_1.getClientCompanies);
 ...
 *         description: 待审批项目列表
 */
router.get("/pending", projectController_1.getPendingProjects);
// ===== 审批相关路由（放在前面，避免被 :id 拦截） =====
/**
 * @swagger
 * /api/projects/draft:
 ...
 *         description: 待审批项目列表
 */
router.get("/draft", projectController_1.getDraftProjects);
/**
 * @swagger
 ...
 */
router.get("/my-draft", projectController_1.getMyDraftProjects);
/**
 * @swagger
 ...
 */
router.get("/pending-delete", projectController_1.getPendingDeleteProjects);
/**
 * @swagger
 * /api/projects/search:
 *   get:
 ...
 *         description: 导出失败
 */
router.get("/export", projectController_1.exportProjectsToExcel);
/**
 * @swagger
 ...
 *         description: 批量审批完成
 */
router.post("/batch-approve", projectController_1.batchApproveProjects);
// ===== Project CRUD =====
/**
 * @swagger
 * /api/projects:
 ...
 *         description: 提交成功
 */
router.post("/:id/submit", projectController_1.submitProjectForApproval);
/**
 * @swagger
 ...
 *         description: 审批完成
 */
router.post("/:id/approve", projectController_1.approveProject);
/**
 * @swagger
 ...
 *         description: 撤回成功
 */
router.post("/:id/withdraw", projectController_1.withdrawProjectApproval);
/**
 * @swagger
 ...
 *         description: 项目不存在
 */
router.post("/:id/request-deletion", projectController_1.requestProjectDeletion);
/**
 * @swagger
 ...
 *         description: 项目不存在
 */
router.post("/:id/withdraw-deletion", projectController_1.withdrawProjectDeletion);
/**
 * @swagger
 ...
 *         description: 审批完成
 */
router.post("/:id/approve-delete", projectController_1.approveProjectDeletion);
/**
 * @swagger
 ...
 *         description: 审批完成
 */
router.post("/:id/approve-deletion", projectController_1.approveProjectDeletion);
