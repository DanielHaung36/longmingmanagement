...
try {
    ...
    keyColumns.forEach(col => {
        const exists = Object.keys(firstRow).some(k => k.toLowerCase().replace(/[^a-z0-9]/g, '') === col.toLowerCase().replace(/[^a-z0-9]/g, ''));
        if (exists) {
            const matchedCol = Object.keys(firstRow).find(k => k.toLowerCase().replace(/[^a-z0-9]/g, '') === col.toLowerCase().replace(/[^a-z0-9]/g, ''));
...
//# sourceMappingURL=diagnoseExcel.js.map