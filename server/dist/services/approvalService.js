...
const projectFolderService_1 = require("./projectFolderService");
...
class ApprovalService {
     ...
     */
    static async approveProject(projectId, approverId, approved, comment) {
        try {
            logger_1.logger.info("开始审批Project", { projectId, approverId, approved });
            ...
            if (!approved) {
                ...
                logger_1.logger.info("Project审批被拒绝", { projectId, reason: comment });
            ...
            logger_1.logger.info("Project审批通过", {
                projectId,
            ...
            logger_1.logger.error("审批Project失败", {
                projectId,
                error: error.message,
                stack: error.stack,
            });
