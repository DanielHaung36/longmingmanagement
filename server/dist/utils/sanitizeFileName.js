...
exports.isValidOneDriveName = isValidOneDriveName;
exports.getInvalidCharsInFileName = getInvalidCharsInFileName;
...
function sanitizeFileName(fileName, options = {}) {
    const { replaceDirSeparator = true, trimDots = true, trimSpaces = true, } = options;
 ...
 */
function isValidOneDriveName(fileName) {
    // 检查禁用字符
 ...
 * 获取需要修复的文件名清单
 */
function getInvalidCharsInFileName(fileName) {
    const invalidChars = [];
    const issues = [];
    // 检查禁用字符
