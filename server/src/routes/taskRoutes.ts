...
const router = Router();
router.use(cookieAuth); // 应用Cookie认证中间件到所有任务路由
/**
 * @swagger
 * /api/tasks/batch:
 *   post:
 ...
 *         description: 导出失败
 */
router.get('/export', TaskController.exportTasksToExcel);
 ...
 *         description: 获取失败
 */
router.get('/minerals', TaskController.getMinerals);
 ...
 *                         type: string
 */
router.get('/pending-deletion', TaskController.getPendingDeletionTasks);
 ...
 *         description: 获取成功
 */
router.get('/draft', TaskController.getDraftTasks);
 ...
 */
router.post('/:id/submit', TaskController.submitForApproval);
 ...
 */
router.post('/:id/withdraw', TaskController.withdrawApproval);
 ...
 *         description: 批量审批成功
 */
router.post('/batch-approve', TaskController.batchApprove);
 ...
 */
router.post('/:id/request-deletion', TaskController.requestDeletion);
 ...
 *         description: 任务状态不允许审批
 */
router.post('/:id/approve-deletion', TaskController.approveDeletion);
 ...
 */
router.post('/:id/withdraw-deletion', TaskController.withdrawDeletion);
