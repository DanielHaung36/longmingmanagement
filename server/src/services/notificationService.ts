import { PrismaClient, NotificationType, Priority, NotificationChannel } from '@prisma/client';
...
export class NotificationService {
   ...
   * 批量创建通知
   */
  static async bulkCreateNotifications(recipientIds: number[], data: Omit<CreateNotificationDTO, 'recipientId'>) {
    try {
   ...
   * 批量删除通知
   */
  static async bulkDeleteNotifications(ids: number[]) {
    try {
